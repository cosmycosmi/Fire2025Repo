...
@Autonomous(name = "Bucketwithlimelight4")
public class bucketwithlimelight extends LinearOpMode {
    ...
    private static final double SLIDE_MAX_HEIGHT = 1000; // Max height in inches
    private static final double SLIDE_MAX_POWER = 1.0;
    private static final double SLIDE_MIN_POWER = 0.2;
    ...
    public void runOpMode() {
        ...
        //MoveViperslideToHeight(27); // Move Viperslide to 27 inches

        Forward(14);MoveViperslideToHeight2(50);
        TurnLeft(45);MoveViperslideToHeight2(50);
        Right(5);
        MoveViperslideToHeight2(50);
        Forward(2);
          al.setPosition(0.6);
       sleep(100);
          al.setPosition(1);
          Backward(12);MoveViperslideToHeight2(0);
       TurnRight(132);
Forward(2);
       ...
       TurnRight(180);
       Right(5);
       Forward(7);MoveViperslideToHeight2(50);
       al.setPosition(.8);
       MoveViperslideToHeight2(50);
       Backward(2);
       TurnLeft(180);
       ...
       // al.setPosition(1);
       // Backward(6.5);
      //  Right(36.3, 0.4); // Strafe right 22 inches at a slower speed of 0.5
...
//        sleep(1000);
     ...
     //   Forward(12.6);
      //  al.setPosition(1);
       // MoveViperslideToHeight(30);
     //   Backward(5);
       // Right(43);
       // TurnRight(162);
      //  Forward(14.5);
      //  MoveViperslideToHeight(23);
      //  al.setPosition(0.8);
        //MoveViperslideToHeight(21);
      //  Backward(20);
      //  Right(50);
        // TurnRight(169);
        //al.setPosition(0.8);
        ...
        //al.setPosition(0.8);
        //Backward(2);
      //  if (intakerotateright.getPosition() > 2) {
       //     intakeright.setPower(1);
       // } else intakeright.setPower(0);
    }
    //hello
    ...
    private void MoveViperslideToHeight(double heightInches) {
        ...
        ElapsedTime timer = new ElapsedTime();
        double timeout = 2.3; // Set timeout in seconds for Viperslide
        ...
        while (opModeIsActive() && timer.seconds() < timeout && Viperslide.isBusy())  {
            ...
            if (Math.abs(error) <= DRIVE_SPOOLING_THRESHOLD) {
                power = SLIDE_MIN_POWER +
                        (SLIDE_MAX_POWER - SLIDE_MIN_POWER) * (Math.abs(error) / DRIVE_SPOOLING_THRESHOLD);
            }
    ...
    private void MoveViperslideToHeight2(double heightInches) {
        if (heightInches < 0) heightInches = 0;
        if (heightInches > SLIDE_MAX_HEIGHT) heightInches = SLIDE_MAX_HEIGHT;
        ...
        ElapsedTime timer = new ElapsedTime();
        double timeout = 4.0; // Set timeout in seconds for Viperslide
