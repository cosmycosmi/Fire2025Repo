...
@TeleOp(name = "Henry auto")
public class fullPickUpCycle extends LinearOpMode {
    ...
    private CRServo intakeleft, intakeright,light;
    ...
    private static final double SLIDE_MAX_HEIGHT = 40.0; // Max height in inches
    ...
    public void runOpMode() {
        ...
        telemetry.addData(">", "Robot Ready.  Press Play.", ">>", "Press start to continue");
                ...
                if (result != null) {
                    ...
                    if (result.isValid()) {
                        ...
                        if (gamepad1.b) {
                            ...
                            if ((sensorDistance.getDistance(DistanceUnit.INCH)) == 1.5) {
                            ...
                            } else if ((sensorDistance.getDistance(DistanceUnit.INCH)) > 1.5) {
                                lf.setDirection(DcMotorSimple.Direction.REVERSE);
                                rf.setDirection(DcMotorSimple.Direction.REVERSE);
                                rb.setDirection(DcMotorSimple.Direction.REVERSE);
                                lb.setDirection(DcMotorSimple.Direction.REVERSE);
    ...
    private void MoveViperslideToHeight(double heightInches) {
        ...
        ElapsedTime timer = new ElapsedTime();
        double timeout = 2.0; // Set timeout in seconds for Viperslide
